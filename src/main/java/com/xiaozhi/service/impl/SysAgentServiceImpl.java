...
//    private ConfigMapper configMapper;
    ...
    private List<SysAgent> getDifyAgents(SysAgent agent) {
        ...
        List<SysConfig> allConfigs = sysConfigRepository.query(queryConfig);
            ...
            if (existingLlmConfig != null) {
                ...
                try {
                    ...
                    if (infoResponse.statusCode() == 200) {
                        ...
                        // 添加到数据库
                        try {
                            sysConfigRepository.add(newLlmConfig);
    ...
    private List<SysAgent> getCozeAgents(SysAgent agent) {
        ...
        // 获取当前用户的Coze配置
        List<SysConfig> configs = sysConfigRepository.query(agent);
        ...
        try {
            ...
            if (response.statusCode() == 200) {
                ...
                if (rootNode.has("code") && rootNode.get("code").asInt() == 0) {
                    ...
                    List<SysConfig> existingConfigs = sysConfigRepository.query(queryConfig);
                    ...
                    for (JsonNode botNode : spaceBots) {
                        ...
                        if (existingConfigMap.containsKey(botId)) {
                            ...
                            // 更新配置
                            try {
                                sysConfigRepository.update(existingConfig);
                            } catch (Exception e) {
                            ...
                            sysConfigRepository.add(newConfig);
                        }
