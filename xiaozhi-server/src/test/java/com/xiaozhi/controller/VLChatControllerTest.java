...
import com.xiaozhi.communication.controller.ImageValidator;
import com.xiaozhi.communication.controller.VLChatController;
...
class VLChatControllerTest extends ControllerTestSupport {
    ...
    void setUp() {
        ...
        injectField(controller, "visionService", visionService);
        injectField(controller, "sessionManager", sessionManager);
        injectField(controller, "deviceAuthService", deviceAuthService);
        injectField(controller, "imageValidator", new ImageValidator());
